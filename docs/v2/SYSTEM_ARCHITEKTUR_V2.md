...
> **LP2 / Upload:** `https://landingpage-haller-immobilienberatu.vercel.app`  
> **LP1 Terminbuchung:** `https://immo-v-haller-terminwahl.vercel.app`  
> **Dashboard:** Vercel-Projekt `inserats-dashboard-haller`  
> **Monorepo:** `apps/` + `packages/` — siehe [`docs/DEPLOYMENT.md`](../DEPLOYMENT.md)
