...
After running `supabase/seed_lp1_demo.sql` on the shared Supabase project:
...
- **GitHub:** [ImmoV_Haller_Terminwahl](https://github.com/ritzaisolutions-dotcom/ImmoV_Haller_Terminwahl.git)
- **Vercel:** Root directory = repository root; set env vars above
